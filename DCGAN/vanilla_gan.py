...
def training_loop(train_dataloader, opts, logger):
    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in train_dataloader:
            ...
            # Log the losses
            logger.add_scalar('D_real_loss', D_real_loss.item(), iteration)
            logger.add_scalar('D_fake_loss', D_fake_loss.item(), iteration)
            logger.add_scalar('D_total_loss', D_total_loss.item(), iteration)
            logger.add_scalar('G_loss', G_loss.item(), iteration)
...
def create_parser():
    ...
    # Data sources
    parser.add_argument('--data', type=str, default='cat/grumpifyAprocessed', help='Choose the type of emojis to generate.')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints_vanilla_basic')
    parser.add_argument('--sample_dir', type=str, default='./vanilla_basic')
...
# tensorboard --logdir=DCGAN/output/vanilla/grumpifyAprocessed_deluxe --host=127.0.0.1
